...
export default function AddRecipient() {
  ...
  return (
    <RootStyle title="Add New Recipient |RemitFix">
      <ContainerStyle>
        <Container maxWidth="sm">
          <Stack direction="column">
            <Typography className={classes.title} align="center" >Add recipient details</Typography>
            ...
            <Button className={classes.button} onClick={onSaveRecipient}>Save recipient</Button>
          </Stack>
        </Container>
      </ContainerStyle>
    </RootStyle >
